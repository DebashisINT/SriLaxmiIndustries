package com.breezefieldbeena.features.logoutsync.presentation
...
import com.breezefieldbeena.app.AppDatabase
...
import com.breezefieldbeena.app.utils.Toaster
import com.breezefieldbeena.base.BaseResponse
import com.breezefieldbeena.base.presentation.BaseActivity
import com.breezefieldbeena.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldbeena.features.billing.api.AddBillingRepoProvider
import com.breezefieldbeena.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldbeena.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldbeena.features.document.model.AddEditDocumentInputParams
import com.breezefieldbeena.features.document.model.DocumentAttachmentModel
...
import com.breezefieldbeena.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldbeena.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldbeena.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldbeena.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldbeena.features.orderhistory.model.*
...
import com.breezefieldbeena.features.quotation.model.AddQuotInputModel
import com.breezefieldbeena.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldbeena.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldbeena.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldbeena.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldbeena.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldbeena.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldbeena.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldbeena.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldbeena.mappackage.SendBrod
import com.breezefieldbeena.widgets.AppCustomTextView
import com.breezefieldbeena.MonitorService
import com.breezefieldbeena.MySingleton
import com.breezefieldbeena.app.AlarmReceiver
...
import com.breezefieldbeena.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldbeena.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldbeena.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldbeena.features.orderITC.SyncDeleteOpptL
import com.breezefieldbeena.features.orderITC.SyncEditOppt
import com.breezefieldbeena.features.orderITC.SyncOppt
import com.breezefieldbeena.features.orderITC.SyncOpptProductL
import com.breezefieldbeena.features.orderITC.SyncOrd
import com.breezefieldbeena.features.orderITC.SyncOrdProductL
import com.breezefieldbeena.features.performance.model.Gps_status_list
import com.breezefieldbeena.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldbeena.features.returnsOrder.ReturnProductList
import com.breezefieldbeena.features.returnsOrder.ReturnRequest
import com.breezefieldbeena.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldbeena.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldbeena/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbeenalogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbeenalogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldbeenalogsample/log.zip").path);
