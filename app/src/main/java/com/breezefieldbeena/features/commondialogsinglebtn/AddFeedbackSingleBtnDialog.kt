package com.breezefieldbeena.features.commondialogsinglebtn
...
import com.breezefieldbeena.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldbeena.app.domain.VisitRemarksEntity
...
import com.breezefieldbeena.features.addshop.presentation.ProspectListDialog
import com.breezefieldbeena.features.dashboard.presentation.DashboardActivity
import com.breezefieldbeena.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldbeena.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldbeena/files", "recorded_audio${System.currentTimeMillis()}.mp3")
