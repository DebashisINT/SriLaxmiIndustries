...
import com.breezefieldbeena.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldbeena.app.utils.FTStorageUtils
import com.breezefieldbeena.app.utils.NotificationUtils
...
import com.breezefieldbeena.features.addshop.model.AssignedToShopListResponseModel
import com.breezefieldbeena.features.addshop.model.QuestionSubmit
import com.breezefieldbeena.features.addshop.model.UpdateAddrReq
import com.breezefieldbeena.features.addshop.model.UpdateAddressShop
...
import com.breezefieldbeena.features.addshop.presentation.*
...
import com.breezefieldbeena.features.location.model.ShopDurationRequestData
...
import com.breezefieldbeena.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldbeena.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldbeena.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldbeena.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezefieldbeena.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldbeenaApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
